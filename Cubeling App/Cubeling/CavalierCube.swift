...
class CavalierCube: UIView {
    ...
    init(x: Int, y: Int, z: Int) {
        ...
        let drawView = CavalierDrawnCube(borderWidth: 2)
...
class CavalierDrawnCube: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        frontFace.setStrokeColor(scondaryLabelColor.cgColor)
        ...
        if(lightMode == 0){
            ...
            frontFace.drawPath(using: CGPathDrawingMode.fill)
        }
